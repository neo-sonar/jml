  ...
  local root = jml.Component{
    ...
    children = {
      jml.ComboBox{
        ...
        height = "25%",
        margin = 4,
        choices = {"Low Cut", "Low Shelf", "Peak", "High Cut", "High Shelf"},
      },
      jml.Component{
        id = "Gain & Quality",
        layout = jml.HorizontalLayout{},
        children = {eq.Rotary{id = "Gain"}, eq.Rotary{id = "Quality"}},
      },
      eq.Rotary{id = "Frequency"},
    },
  }
...
function eq.Analyzer(spec)
  ...
  local root = jml.Component{
    ...
    fill = juce.Colours.black,
    children = {
      jml.Component{id = "Red", margin = 4, fill = juce.Colours.white},
    },
  }
...
local ui = jml.Component{
  ...
  layout = jml.VerticalLayout{},
  children = {
    eq.Analyzer{id = "Analyzer", height = "45%"},
    jml.Component{
      id = "Bands",
      layout = jml.HorizontalLayout{},
      children = {
        eq.Band{id = "Band Low"},
        eq.Band{id = "Band Low Mid"},
        eq.Band{id = "Band Mid"},
        eq.Band{id = "Band High Mid"},
        eq.Band{id = "Band High"},
      },
    },
  },
}
