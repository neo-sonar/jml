...
auto makeCodeEditorColorScheme() -> juce::CodeEditorComponent::ColourScheme
{
    ...
    static auto const types = std::array{
        TokenType{"Error", juce::Colour(0xffcc0000)},       TokenType{"Comment", OneLightColours::codeComment},
        TokenType{"Keyword", OneLightColours::codeKeyword}, TokenType{"Operator", OneLightColours::codeOperator},
        TokenType{"Identifier", juce::Colour(0xff000000)},  TokenType{"Integer", OneLightColours::codeInteger},
        TokenType{"Float", OneLightColours::codeFloat},     TokenType{"String", OneLightColours::codeString},
        TokenType{"Bracket", OneLightColours::codeBracket}, TokenType{"Punctuation", juce::Colour(0xff004400)},
    };
